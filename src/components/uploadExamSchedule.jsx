...
export const UploadExamSchedule = () => {
    const [examSchedule, setExamSchedule] = useState([
        { id: '1', subject: 'Math', date: '2025-12-15', time: '09:00 AM - 12:00 PM', room: 'Exam Hall 1' },
        { id: '2', subject: 'Science', date: '2025-12-17', time: '02:00 PM - 05:00 PM', room: 'Exam Hall 2' },
    ]);
    ...
    const handleSubmit = (e) => {
        ...
        if (isEditing) {
            ...
            setModalMessage('Exam schedule updated successfully!');
        } else {
            const newItem = { ...formData, id: Date.now().toString() };
            setExamSchedule([...examSchedule, newItem]);
            setModalMessage('Exam schedule added successfully!');
        }
        setShowModal(true);
            ...
            <form onSubmit={handleSubmit} className="bg-gray-100 p-6 rounded-lg mb-8 shadow-inner">
                ...
                <div className="mt-6 flex gap-4">
                    ...
                    {isEditing && (
                        <button
                            type="button"
                            onClick={() => { setIsEditing(false); setFormData({ id: '', subject: '', date: '', time: '', room: '' }); }}
                ...
                <table className="min-w-full leading-normal">
                    <thead>
                        <tr className="bg-blue-600 text-white">
                            <th className="px-5 py-3 border-b-2 border-gray-200 text-left text-xs font-semibold uppercase tracking-wider rounded-tl-lg">Subject</th>
                        ...
                        {examSchedule.length > 0 ? (
                            examSchedule.map(item => (
                                <tr key={item.id} className="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td className="px-5 py-4 border-b border-gray-200 bg-white text-sm">{item.date}</td>
